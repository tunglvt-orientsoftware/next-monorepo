    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f5f4ed] p-4 font-serif">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-sm">
        <div className="text-center">
          <h2 className="text-3xl font-medium text-slate-900 tracking-tight">Create an account</h2>
          <p className="mt-2 text-sm text-slate-600">Start your journey with Travel AI</p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <form action={signup} className="space-y-6">
            ...
            <SubmitButton
              ...
              className="w-full bg-[#c96442] hover:bg-[#b05537] text-white rounded-full h-11 font-sans"
            >
              Sign up
            </SubmitButton>
          </form>
          ...
          <p className="text-center text-sm text-slate-600 font-sans">
            ...
            <Link href="/login" className="font-medium text-[#c96442] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
